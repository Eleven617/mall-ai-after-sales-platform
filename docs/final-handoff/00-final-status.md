...
当前 Runtime/image `d4ec989548e953a8f8c5ee7ceef4ea13b464fbfb` 的机器报告为 FastAPI **508/508**（492 cases + 16 subtests）、manifest **478/478**、representative **8/8**、contract replay **36/36**；当前 Runtime/image 现场 **122/122**。
