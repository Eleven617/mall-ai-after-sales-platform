...
- 首次 `git push` 曾在 GitHub `443` 连接处超时，随后提交 `5629f7b3529ef03b6833b329b580f212c96b38bb` 已成功推送。该 SHA 的 `quality-evaluation` [run 34941472352](https://github.com/Eleven617/mall-ai-after-sales-platform/actions/runs/34941472352) 成功，`mall-ci` [run 34941472321](https://github.com/Eleven617/mall-ai-after-sales-platform/actions/runs/34941472321) 失败于 `public-release`：公开验证器仍硬编码历史 FastAPI `381`，而当前实测为 `382`。不能把旧 run 当作新结果。
